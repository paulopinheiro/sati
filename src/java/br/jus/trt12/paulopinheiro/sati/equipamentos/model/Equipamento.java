...
public class Equipamento implements Serializable, Comparable {
    ...
    public String toString() {
        ...
        if (this.usuarioEquipamento != null) return this.getTombo() + " - " + this.getUnidade().getSigla() + " (" + this.getUsuarioEquipamento().getNome() + ")";
        if (this.observacao != null) return this.getTombo() + " - " + this.getUnidade().getSigla() + " (" + this.getObservacao() + ")";
        return this.getTombo() + " - " + this.getUnidade().getSigla();
    }
